...
public class FacebookRequestPost {
	private final CloseableHttpClient http;
	private final HttpGet request;

	public FacebookRequestPost(String pageId) throws URISyntaxException {
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		FacebookRequestPost v3 = new FacebookRequestPost("1421110321440678");
